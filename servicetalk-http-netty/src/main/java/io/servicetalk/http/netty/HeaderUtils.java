...
final class HeaderUtils {
    ...
    static ScanConcatMapper<Object, Object> insertTrailersMapper() {
        return new ScanConcatMapper<Object, Object>() {
            @Nullable
            private boolean sawHeaders;

            @Nullable
            @Override
            public Object onNext(@Nullable final Object next) {
            ...
            @Nullable
            @Override
            public Object onError(final Throwable t) throws Throwable {
                throw t;
            }
