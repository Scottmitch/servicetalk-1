...
/**
 * {@link ServiceDiscoverer} which targets <a href="https://tools.ietf.org/html/rfc1035">DNS</a> for discovery.
 */
public interface DnsClient extends ListenableAsyncCloseable {
     ...
     * change.
     */
    Publisher<ServiceDiscovererEvent<InetAddress>> dnsQuery(String hostName);
     ...
     * change.
     */
    Publisher<ServiceDiscovererEvent<InetSocketAddress>> dnsSrvQuery(String serviceName);
